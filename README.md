# Calendly (calendly)
Calendly is an online scheduling platform that eliminates the back-and-forth of meeting coordination. Their developer platform provides APIs for programmatically managing scheduling workflows, receiving real-time event notifications via webhooks, and embedding scheduling interfaces directly into third-party applications.

**URL:** [Visit APIs.json URL](https://raw.githubusercontent.com/api-evangelist/calendly/refs/heads/main/apis.yml)
...
## Tags:
 ...
 - Scheduling, Calendars, Meetings, Appointments, Booking, Automation
...
- [OpenAPI](openapi/calendly-scheduling-api-openapi.yml)
...
#### Tags:
 ...
 - Webhooks, Events, Notifications, Scheduling

#### Properties

- [Documentation](https://developer.calendly.com/api-docs)
- [AsyncAPI](asyncapi/calendly-webhook-api-asyncapi.yml)
...
#### Tags:
 ...
 - Embedding, Widgets, Scheduling, Web Components
...
- [TermsOfService](https://calendly.com/terms)
